...
You are an expert QA Engineer specializing in regulated healthcare software.
Your task is to analyze a software requirement and generate a comprehensive set of test cases.
...
SEGMENTATION_PROMPT = """
You are an expert Business Analyst specializing in software requirements engineering.
Your task is to analyze a large text document containing software requirements and break it down into a list of distinct, individual requirements.
...
You are an expert QA Architect who specializes in categorizing software requirements into logical domains for testing purposes.
