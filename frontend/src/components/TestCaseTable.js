...
import { EmptyStateIcon, DeleteIcon } from './icons';
                        ...
                        <React.Fragment key={`${tc.docId}-${tc.test_case_id}`}>
                            <tr className="hover:bg-gray-50 dark:hover:bg-gray-800/60 transition-colors">
                                ...
                                <td className="p-4 text-right space-x-2 whitespace-nowrap">
                                    ...
                                    {handleCreateJiraIssue && <button onClick={() => handleCreateJiraIssue(tc)} className="p-2 text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-md">Create Jira Ticket</button>}
